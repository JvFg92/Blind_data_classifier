...
if __name__ == "__main__":
  ...
  cs.evaluate_classifier(knn, xtest, ytest, name='KNN Classifier')

  rf=cs.random_forest(xtrain, ytrain)
  cs.evaluate_classifier(rf, xtest, ytest, name='Random Forest Classifier')
  
  mlp=cs.neural_network(xtrain, ytrain)
  cs.evaluate_classifier(mlp, xtest, ytest, name='MLP Classifier')
